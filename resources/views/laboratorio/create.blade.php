                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-4">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control @error('edificio') is-invalid  @enderror" name="edificio" placeholder="Enter ..." autocomplete="off" value="{{old('edificio')}}">
                                  @error('edificio')
                                  <div class="invalid-feedback">
                              ...
                              <div class="col-sm-4">
                                <div class="form-group">
                                  ...
                                  <input type="text"  class="form-control @error('capacidad') is-invalid @enderror" name="capacidad" id="capacidad" placeholder="Ej. 20" autocomplete="off" value="{{old('capacidad')}}">
                                  <div class="invalid-feedback">
